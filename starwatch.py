...
STARS = [
    ...
    {"name": "腰帶三星 (Orion's Belt)", "constellation": "獵戶座", "ra": 5.60, "dec": -1.20, "mag": 1.69},
    ...
    {"name": "金星 (Venus)", "is_planet": True, "ra": None, "dec": None, "mag": -4.0, "constellation": "行星"},
    {"name": "火星 (Mars)", "is_planet": True, "ra": None, "dec": None, "mag": -2.0, "constellation": "行星"},
    {"name": "木星 (Jupiter)", "is_planet": True, "ra": None, "dec": None, "mag": -2.5, "constellation": "行星"},
]
